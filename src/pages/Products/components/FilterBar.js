          ...
          <ul className="text-slate-700 dark:text-slate-100">
            ...
            <li className="mt-1 mb-5 px-1">
              <button
                ...
                type="button"
                className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-10 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700dark:focus:ring-gray-700"
              >
                필터 초기화
              </button>
            </li>
